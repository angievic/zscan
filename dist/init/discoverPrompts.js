...
const CODE_ROOTS = ["src", "lib", "app", "cmd", "pkg", "internal"];
/** Extensiones: TS/JS, Python, Ruby, Go, Java, Kotlin. */
const CODE_GLOB_EXTENSIONS = "ts,tsx,js,jsx,mjs,cjs,py,rb,go,java,kt";
...
function discoverCodePromptBuckets(cwd, ignore) {
    const groups = [];
 ...
 */
export function discoverPromptGroupsForInit(root) {
        ...
        return [
            {
                ...
                purpose: "Sin coincidencias: ajusta estos globs a tus carpetas de documentación o prompts",
            },
        ];
    }
    return out;
