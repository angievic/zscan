 ...
 */
export function parsePnpmPackageKeys(keys: string[]): LockfilePackage[] {
  ...
  for (const key of keys) {
    ...
    if (at > 0) version = version.slice(0, at);
...
export function readPnpmLockfile(lockPath: string): LockfilePackage[] {
